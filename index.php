...
<div class="header">
  <div class="header-inside">
    ...
    <div class="menu"> <a href="index.php" class="selected_a">Inicio</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="acerca.php" class="notselected_a">Acerca de Nosotros</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="servicios.php" class="notselected_a">Nuestros Servicios</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="contacto.php" class="notselected_a">Contacto</a> </div>
  </div>
</div>
...
<div class="featured_content">
  ...
  <div class="article-1-text">Creamos software que se apega estrictamente a sus necesidades de negocio, aplicando altos est&aacute;ndares de calidad. <a href="softwaremedida.php" target="_self" class="link_featured">Leer m&aacute;s.</a></div>
  ...
  <div class="article-2-text">Maximice el rendimiento del software en su organizaci&oacute;n, ajustando la funcionalidad del mismo, optimizando su inversi&oacute;n. <a href="softwaremodificado.php" target="_self" class="link_featured">Leer m&aacute;s.</a></div>
  ...
  <div class="article-3-text">Le ayudamos a promover sus productos o servicios en l&iacute;nea, ya sea por medio de sitios web informativos o E-Commerce. <a href="ecommerce.php" target="_self" class="link_featured">Leer m&aacute;s.</a></div>
</div>
<div class="technologies">
  <div class="technologies-text">
    <h2>Diversidad de tecnolog&iacute;as a su disposici&oacute;n</h2>
