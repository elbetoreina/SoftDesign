...
<div class="header">
  <div class="header-inside">
    ...
    <div class="menu"> <a href="index.php" class="notselected_a">Inicio</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="acerca.php" class="notselected_a">Acerca de Nosotros</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="servicios.php" class="selected_a">Nuestros Servicios</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="contacto.php" class="notselected_a">Contacto</a> </div>
  </div>
</div>
<div class="servicios_prestados">
  <div class="technologies-text">
    <h2>Desarrollo de software a la medida</h2>
    <p>
    Si usted y su organizaci&oacute;n, en alguna de sus &aacute;reas de negocio necesitan automatizar alg&uacute;n proceso y desean que &eacuteste sea creado adecu&aacute;ndose con precisi&oacute;n a sus requerimientos, SoftDesign le ofrece crear software a la medida. </p>
    <h2>Ajuste de software existente</h2>
    <p>Si su organizaci&oacute;n ha comprado alg&uacute;n software a nivel nacional o internacional, y este no se adapta en un 100% a las necesidades por las cuales fue adquirido, SoftDesign puede ayudarle a modificarlo, de forma que usted pueda obtener un r&aacute;pido retorno de su inversi&oacute;n y adem&aacute;s, una mejora real en sus procesos de negocio.</p>
